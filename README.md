...
- encourages high-quality code examples as a normal part of teaching: small first, modular for non-trivial code, typed and documented where the ecosystem expects it, and matched to the current repo's conventions,
