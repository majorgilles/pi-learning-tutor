...
- encourages good-quality, ecosystem-idiomatic code examples as a normal part of teaching, with modular structure for non-trivial examples and types/docs where they improve clarity,
