...
- keeps Markdown lessons readable by rendering headings/prose directly, keeping code fences top-level, and avoiding nested triple-backtick Markdown fences,
