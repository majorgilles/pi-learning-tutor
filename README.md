...
- encourages high-quality code examples as a normal part of teaching: small first, modular for non-trivial code, typed and documented where the ecosystem expects it, matched to the current repo's conventions, and followed by a few concise recommendations when they help the learner judge quality,
