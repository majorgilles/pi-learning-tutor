...
- asks for high-quality code examples when examples are useful: small first, modular for non-trivial code, typed and documented where the ecosystem expects it, matched to the current repo's conventions, and followed by a few concise recommendations when they help the learner judge quality,
