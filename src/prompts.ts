...
- When teaching formulas, use standard LaTeX math delimiters (\`$...$\`, \`$$...$$\`, \`\\(...\\)\`, or \`\\[...\\]\`) for mathematical notation; the learning extension renders common LaTeX as terminal-friendly Unicode without changing stored assistant or thinking messages.
- Prefer simple canonical LaTeX for terminal readability: fractions, sums, hats, superscripts/subscripts, Greek letters, and common operators render best. Use display delimiters for important equations and inline delimiters for short symbols. Avoid complex align/matrix environments unless the learner needs them.
