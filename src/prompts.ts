...
const CODE_EXAMPLE_QUALITY_RULES = `Code examples:
- Provide good-quality, ecosystem-idiomatic code examples as a normal part of teaching.
- For non-trivial examples, use modular structure: focused helpers, clear boundaries, meaningful names, and sensible file placement.
- Include types and concise docs/comments where they are idiomatic and improve clarity.`;
...
5. Make non-trivial code examples modular and typed/documented where idiomatic.
